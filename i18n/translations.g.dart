...
/// Strings: 1
///
/// Built on 2024-02-17 at 08:57 UTC
...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	late final _TranslationsErrorRu error = _TranslationsErrorRu._(_root);
}

// Path: error
class _TranslationsErrorRu {
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'error.somethingWentWrong': return 'Что-то пошло не так...';
			default: return null;
		}
	}
}
