...
/// Strings: 2
///
/// Built on 2024-02-17 at 08:59 UTC
...
class _TranslationsErrorsRu {
	...
	String get noConnect => 'Не удалость подключиться, проверьте состояние сети';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'errors.somethingWentWrong': return 'Что-то пошло не так...';
			case 'errors.noConnect': return 'Не удалость подключиться, проверьте состояние сети';
			default: return null;
		}
	}
}
